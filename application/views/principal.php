    ...
    <div class="col-xs-6 col-sm-4  col-md-10">
        <ul class="list-inline">
          <?php foreach($produtos as $idx => $produto):?>
            <li href="<?=base_url('assets/img/banner/'.$produto->nome_arquivo) ?>" class="thumbnail">
              <img src="<?=base_url('assets/img/produtos/'.$produto->nome_arquivo) ?>" alt="<?=$produto->nome_arquivo ?>" style="height:150px">
